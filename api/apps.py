...
class ApiConfig(AppConfig):
    ...
    def ready(self):
        ...
        # Only attempt to schedule tasks if running the development server or task processor
        # This avoids database access during commands like `makemigrations`, `migrate`, `test`, etc.
        if 'runserver' in sys.argv or 'process_tasks' in sys.argv:
            ...
            logger.debug("Skipping background task scheduling during non-server command.")
